...
export const route: Route = {
    path: '/wchscu/technology',
    categories: ['university'],
    example: '/scu/wchscu/technology',
    parameters: {},
    features: {
        requireConfig: false,
    ...
    handler: async () => {
        ...
        const response = await ofetch(`${baseUrl}/technology.html`);
        const $ = load(response);
        ...
        return {
            title: '四川大学华西医院-医疗新技术',
            link: `${baseUrl}/technology.html`,
            item: items,
        };
    },
};
